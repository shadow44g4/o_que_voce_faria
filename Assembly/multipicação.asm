.data
	...
	Resultado: .asciiz "Resultado da Multiplicação: "
...
.text
	...
	#tenho dois valores em $t0 e $t1, so preciso fazer a multiplicação
	
	mult $t0,$t1 # multiplica o $t1 pelo $t0 , dois registradores de 32bit ou seja agora temos 64 bits
	#para multiplicar numeros altos usamos "mfhi" e para nºs baixos "mflo"
